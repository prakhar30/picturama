export default {
    ...
    ExportDialog_removeInfo_desc: `This removes extra information like EXIF-Tags from the exported photo. This is information about the camera used, the photo's location or similar.`,
    ExportDialog_removeInfo_jpgOnly: 'Extra information is currently only supported for JPG. I.e. extra information is only exported if both the original photo and the exported photo are JPG.',
